...
function App() {
  ...
  return (
    <div className="site-shell">
      ...
      <footer><div className="container footer-inner"><p>© 2021–2026 {content.profile.name}. {t(content.labels.footerRights)}</p></div></footer>
